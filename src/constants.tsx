...
export const developers: Person[] = [
  {
    ...
    title: 'Legend & Owner',
    image: 'phuc.jpeg',
    email: 'tra17719@spengergasse.at',
    discord: 'Glup3#4306',
    paypal: 'https://www.paypal.me/glup3tran',
  },
  {
    name: 'Glup3',
    ...
    github: 'https://github.com/glup3',
    linkedin: 'https://www.linkedin.com/in/phuc-tran-bb7773178/',
    youtube: 'https://www.youtube.com/channel/UCN8LfiD2wp_DmTbiVXNhl0g',
  },
];
...
export const helpers: Person[] = [
  ...
  },
  {
    ...
    title: 'Designer',
    image: 'max.jpeg',
    twitter: 'https://twitter.com/ukalto',
    email: 'maxi.gaber@gmail.com',
